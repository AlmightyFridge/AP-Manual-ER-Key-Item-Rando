...
def before_create_items_all(item_config: dict[str, int|dict], world: World, multiworld: MultiWorld, player: int) -> dict[str, int|dict]:
    ...
    #adding items to the pool to fill out optional locations
    if is_option_enabled(multiworld, player, "Shopsanity"):
        item_config["Free Weapon"] += 2
        item_config["Free Shield"] += 2
        item_config["Free Armor"] += 2
        item_config["Free Spell"] += 2
        item_config["Free +0 Talisman"] += 2
...
def before_create_items_filler(item_pool: list, world: World, multiworld: MultiWorld, player: int) -> list:
    ...
    if is_option_enabled(multiworld, player, "Vanilla_Great_Runes"):
        itemName = "Great Rune"
        GR_location_list = ["Godrick the Grafted Defeated", "Rennala Defeated", "Starscourge Radahn Defeated", "Morgott Defeated", "Rykard Defeated", "Malenia Defeated", "Mohg Defeated"]

        for loc_name in GR_location_list:
